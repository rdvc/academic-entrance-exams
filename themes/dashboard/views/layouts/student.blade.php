...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <!-- Preloader -->
    <div class="preloader flex-column justify-content-center align-items-center" style="background-color: #4d5459">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #4d5459">
      <!-- Brand Logo -->
